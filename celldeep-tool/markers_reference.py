...
MARKER_LIBRARY = {
    ...
    "hs-CRP": dict(category="Inflammation", unit="mg/L", kind="bounded",
        direction="lower", optimal=1.0, moderate=3.0, inclusive=False, disp_range="optimal <1.0",
    ...
    "Myeloperoxidase": dict(category="Inflammation", unit="pmol/L", kind="bounded",
        direction="lower", optimal=470, moderate=539, inclusive=False, disp_range="optimal <470",
    ...
    "ADMA": dict(category="Inflammation", unit="ng/mL", kind="bounded",
        direction="lower", optimal=100, moderate=120, inclusive=False, disp_range="optimal <100",
    ...
    "Oxidized LDL": dict(category="Inflammation", unit="U/L", kind="bounded",
        direction="lower", optimal=60, moderate=69, inclusive=False, disp_range="optimal <60",
        aliases=["oxidized ldl", "ox-ldl", "oxldl"]),
    "Fibrinogen": dict(category="Inflammation", unit="mg/dL", kind="bounded",
        direction="lower", optimal=350, moderate=350, inclusive=False, disp_range="optimal <350",
        aliases=["fibrinogen"]),
    ...
    "HbA1c": dict(category="Metabolic", unit="%", kind="bounded",
        direction="lower", optimal=5.7, moderate=6.4, inclusive=False, disp_range="optimal <5.7%",
    ...
    "Insulin Resistance Score": dict(category="Metabolic", unit="", kind="bounded",
        direction="lower", optimal=33, moderate=66, inclusive=False, disp_range="sensitive <33",
    ...
    "Estradiol": dict(category="Hormones", unit="pg/mL", kind="range",
        disp_range="sex-specific default (female BHRT target; male 20\u201345)",
        default_sex="female",
        sex_variants={
    ...
    "Testosterone, Total": dict(category="Hormones", unit="ng/dL", kind="range",
        ...
        sex_variants={
            ...
            "female": dict(lo=None, hi=None, disp_range="male-specific target only"),
        },
    ...
    "Thyroid Peroxidase Ab": dict(category="Thyroid", unit="IU/mL", kind="bounded",
        direction="lower", optimal=35, moderate=100, inclusive=False, disp_range="optimal <35",
        aliases=["tpo ab", "thyroid peroxidase antibody", "tpo antibody"]),
    "Thyroglobulin Ab": dict(category="Thyroid", unit="IU/mL", kind="bounded",
        direction="lower", optimal=115, moderate=115, inclusive=False, disp_range="optimal <115",
        aliases=["thyroglobulin ab", "thyroglobulin antibody", "thyroglobulin antibodies", "thyroglobulin antibody, serum", "tg ab", "tgab"]),

    # ---- Foundational ----
    "Vitamin D": dict(category="Foundational", unit="ng/mL", kind="range",
        lo=60, hi=90, disp_range="60\u201390",
    ...
    "CoQ10": dict(category="Foundational", unit="\u00b5g/mL", kind="bounded",
        direction="higher", optimal=0.35, moderate=0.35, inclusive=False, disp_range="optimal >0.35",
    ...
    "Folate": dict(category="Foundational", unit="ng/mL", kind="bounded",
        direction="higher", optimal=5.4, moderate=5.4, inclusive=False, disp_range="optimal >5.4",
    ...
    "eGFR": dict(category="Also Monitored", unit="mL/min/1.73m^2", kind="bounded",
        direction="higher", optimal=70, moderate=70, inclusive=False, disp_range="optimal >70",
    ...
    "Progesterone": dict(category="Hormones", unit="ng/mL", kind="range",
        disp_range="postmenopausal BHRT target only", default_sex="female",
        sex_variants={
            "female": dict(lo=None, hi=None, disp_range="postmenopausal BHRT target only"),
            "male": dict(lo=None, hi=None, disp_range="not applicable for male patients"),
        },
    ...
    "Bioavailable Testosterone": dict(category="Hormones", unit="ng/dL", kind="range",
        ...
        sex_variants={
            "female": dict(lo=None, hi=None, disp_range="male-specific target only"),
            "male": dict(lo=250, hi=500, disp_range="250\u2013500"),
        },
...
def resolve_marker_config(canonical: str, cfg: dict, sex: str | None,
    ...
    if canonical in {"Estradiol", "Progesterone", "Free Testosterone", "SHBG"} and key == "female" and postmenopausal_bhrt is True:
        bhrt_targets = {
            "Estradiol": (80, 120),
            "Progesterone": (2, 10),
            "Free Testosterone": (2.5, 5.0),
            "SHBG": (24.6, 122),
        }
        lo, hi = bhrt_targets[canonical]
        resolved.update(lo=lo, hi=hi, disp_range=f"{lo}\u2013{hi} (postmenopausal BHRT target)")
    return resolved
